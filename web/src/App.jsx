  ...
  if (!user) {
    ...
    return (
      ...
      >
        ...
        <div style={{ position: "absolute", top: 51, left: 0, right: 0, zIndex: 3, display: "flex", justifyContent: "center", transform: "translateX(420px)" }}>
          <ThemeToggle
            style={
              dark
                ? {
        ...
        <div style={{ position: "relative", zIndex: 2, marginTop: 132, padding: "0 16px", transform: "translateX(420px)" }}>
          <Login splash={dark} />
        </div>
      </div>
    );
