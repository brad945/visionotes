...
export default function Login({ splash = false }) {
  ...
  const handleLogin = async (e) => {
    ...
    if (authError) {
      ...
      // tell the hero hand to rearrange its dots into a thumbs-up (it listens on window)
    ...
    <main style={{ maxWidth: 360, margin: "0 auto", textAlign: "center" }}>
      ...
      <form onSubmit={handleLogin} noValidate>
        ...
        <button
          ...
          style={{ marginTop: 12, width: "60%", display: "block", marginLeft: "auto", marginRight: "auto" }}
        >
          Send link
        </button>
      </form>
